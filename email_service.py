...
class EmailService:
    ...
    def send_email(self, receiver_email, email_type, variables):
    ...
    def send_welcome_email(self, receiver_email, name, email, login_url):
        ...
        return self.send_email(receiver_email, 'welcome_email', variables)
    
    def send_account_confirmation_email(self, receiver_email, name, verification_url, expiry_hours=1):
        ...
        return self.send_email(receiver_email, 'account_confirmation_email', variables)
    
    def send_password_reset_email(self, receiver_email, name, reset_link, expiry_hours=24):
        ...
        return self.send_email(receiver_email, 'password_reset_email', variables)
    
    def send_access_key_email(self, receiver_email, name, service_name, access_key, 
                            generated_date, expiry_date, expiry_hours=72):
        ...
        return self.send_email(receiver_email, 'access_key_email', variables)
    ...
    def send_invoice_email(self, receiver_email, customer_name, customer_email, invoice_number,
        ...
        return self.send_email(receiver_email, 'invoice_email', variables)
